...
このアプリは「.md」に対応していますが、「.md」「.mdx」に対応したブログアプリを作成しています。

mdxに対応した新ブログアプリはこのブログに機能を足したバージョンとなっています。

また、新ブログアプリに関しては継続して機能の追加をしています。

そのため、そちらをご覧ください。

github: https://github.com/haru0354/next-blog-ssg-mdx
